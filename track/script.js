...
<p>${'Yesterday -' + data[0].timeframes.daily.previous + 'hrs'} </p>'
  period[1].innerHTML='<p>${data[1].timeframes.daily.current + 'hrs'} </p>
  <p>${'Yesterday -' + data[1].timeframes.daily.previous + 'hrs'} </p>'
  period[2].innerHTML='<p>${data[2].timeframes.daily.current + 'hrs'} </p>
<p>${'Yesterday -' + data[2].timeframes.daily.previous + 'hrs'} </p>'
  period[3].innerHTML='<p>${data[3].timeframes.daily.current + 'hrs'} </p>
  <p>${'Yesterday -' + data[3].timeframes.daily.previous + 'hrs'} </p>'
  period[4].innerHTML='<p>${data[4].timeframes.daily.current + 'hrs'} </p>
<p>${'Yesterday -' + data[4].timeframes.daily.previous + 'hrs'} </p>'
  period[5].innerHTML='<p>${data[5].timeframes.daily.current + 'hrs'} </p>
...
<p>${'Last Week-' + data[4].timeframes.weekly.previous + 'hrs'} </p>'
  period[5].innerHTML='<p>${data[5].timeframes.weekly.current + 'hrs'} </p>
